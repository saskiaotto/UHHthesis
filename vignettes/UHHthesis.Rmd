...
---
title: "Introduction to the UHHthesis package"
output: rmarkdown::html_vignette
description: >
  Introduction to the English and German R Markdown templates for PDF and MS Word output, their usage as well as prerequisites.
vignette: >
  %\VignetteIndexEntry{Introduction to the UHHthesis package}
...
<img src="images/UHHthesis_logo.png" align="right" width="100" height="100"/>
...
knitr::include_graphics("images/img_rename_index_file.jpg")
```
...
knitr::include_graphics("images/img_knit_index_file.jpg")
```
...
knitr::include_graphics("images/img_thesis_pdf.jpg")
```
...
knitr::include_graphics("images/img_thesis_word.jpg")
```
